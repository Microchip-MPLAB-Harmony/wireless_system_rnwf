...
def instantiateComponent(sysEccRNWFComponent):
    ...
    sysrnwfeccHeaderFile.setSourcePath("system/Ecc/templates/sys_rnwf_ecc_service.h.ftl")
    ...
    print("ECC Service Component Header Path %s", sysrnwfeccHeaderFile.getProjectPath())
	
    sysrnwfeccSourceFile = sysEccRNWFComponent.createFileSymbol("SYS_RNWF_NET_SOURCE", None)
    sysrnwfeccSourceFile.setSourcePath("system/Ecc/templates/src/sys_rnwf_ecc_service.c.ftl")
    ...
    sysrnwfeccSystemConfigFile.setSourcePath("system/Ecc/templates/system/system_config.h.ftl")
