...
#define SYS_RNWF_STA_SECURITY				SYS_RNWF_WIFI_SECURITY_OPEN
...
#define SYS_RNWF_STA_SECURITY				SYS_RNWF_WIFI_SECURITY_WPA3
<#elseif SYS_RNWF_WIFI_STA_SECURITY == "WPA2-MIXED">
#define SYS_RNWF_STA_SECURITY				SYS_RNWF_WIFI_SECURITY_WPA2_MIXED
<#elseif SYS_RNWF_WIFI_STA_SECURITY == "WPA3-TRANS">
#define SYS_RNWF_STA_SECURITY				SYS_RNWF_WIFI_SECURITY_WPA3_TRANS
</#if>
...
#define SYS_RNWF_SOFT_AP_SECURITY			SYS_RNWF_WIFI_SECURITY_OPEN
<#elseif SYS_RNWF_WIFI_AP_SECURITY == "WPA2">
#define SYS_RNWF_SOFT_AP_SECURITY			SYS_RNWF_WIFI_SECURITY_WPA2
<#elseif SYS_RNWF_WIFI_AP_SECURITY == "WPA2-MIXED">
#define SYS_RNWF_SOFT_AP_SECURITY			SYS_RNWF_WIFI_SECURITY_WPA2_MIXED
<#elseif SYS_RNWF_WIFI_AP_SECURITY == "WPA3">
#define SYS_RNWF_SOFT_AP_SECURITY			SYS_RNWF_WIFI_SECURITY_WPA3
<#elseif SYS_RNWF_WIFI_AP_SECURITY == "WPA3-TRANS">
#define SYS_RNWF_SOFT_AP_SECURITY			SYS_RNWF_WIFI_SECURITY_WPA3_TRANS
</#if>
#define SYS_RNWF_WIFI_CHANNEL               ${SYS_RNWF_WIFI_SECURITY_AP_CHANNEL}
</#if>
...
#define SYS_RNWF_PROV_SECURITY				SYS_RNWF_WIFI_SECURITY_OPEN
...
#define SYS_RNWF_PROV_SECURITY				SYS_RNWF_WIFI_SECURITY_WPA2_MIXED
<#elseif SYS_RNWF_WIFI_PROV_SECURITY == "WPA3">
#define SYS_RNWF_PROV_SECURITY				SYS_RNWF_WIFI_SECURITY_WPA3
<#elseif SYS_RNWF_WIFI_PROV_SECURITY == "WPA3-TRANS">
#define SYS_RNWF_PROV_SECURITY				SYS_RNWF_WIFI_SECURITY_WPA3_TRANS
</#if>
...
#define SYS_RNWF_DNS_URL                    "${SYS_RNWF_DNS_URL}"
</#if>
